...
3. Select **Monitoring Console** from the menu.
  ...
  ![Open the Monitoring Console](/cortex-certifai/img/open-monitoring-console.png)

4. The Monitoring Dashboard is displayed. Select a project from the dropdown menu at the top right.

  ![Select a Project](/cortex-certifai/img/monitoring-dashboard-select-project.png)
...
6. Set the date range for the graphical displays by selecting start and stop dates from the calendar widget to the right under the tabs. (Defaults to showing all available data)
  ...
  ![Select date range](/cortex-certifai/img/monitoring-dashboard-date-range.png)
...
7. View details and values on the graphs by hovering over the x-y intercepts.
  ...
  Two types of hover views are displayed:
    ...
    - When a single evaluation has been run for a given date this is the view:
      ...
      ![Hover to view values-single run](/cortex-certifai/img/md-hover-one-run.png)
    ...
    - When multiple evaluation runs have occurred on a given day, the Categorical Feature Distribution displays the top five values, determined by highest count in the range of dates provided, are expressed as "Worst Case". Depending on the graph being displayed, the Worst Case can vary. In the numeric quartile graphs, the Worst Case will be the scan where the IQR is the largest.
      ...
      ![Hover to view values-multiple runs](/cortex-certifai/img/md-hover-multi-runs.png)
...
![Total predictions graph](/cortex-certifai/img/md-total-predictions.png)
...
![Predictions drift graph](/cortex-certifai/img/md-prediction-drift.png)
...
![Predictions label distribution: regression](/cortex-certifai/img/md-prediction-value-distribution-regression.png)
...
![Predictions label distribution graph: classification](/cortex-certifai/img/md-prediction-label-distribution-classification.png)
...
![Feature data quality graph](/cortex-certifai/img/md-feature-data-quality.png)
...
![Numeric feature drift graph](/cortex-certifai/img/md-numeric-feature-distribution.png)
...
### Categorical Feature Distribution
 ...
 ![Categorical Feature Distribution graph](/cortex-certifai/img/md-categorical-feature-distribution.png)
...
![Numeric Feature Distribution](/cortex-certifai/img/md-numeric-feature-distribution.png)
...
![Performance graphs](/cortex-certifai/img/md-performance.png)
...
![Fairness graphs](/cortex-certifai/img/md-fairness.png)
